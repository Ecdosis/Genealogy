 ...
 * @author desmond
 */
public class GenealogyWebApp extends HttpServlet
{
        ...
        throws ServletException, java.io.IOException
    {
        try
        {
            ...
            GenealogyHandler handler;
            if ( method.equals("GET") )
                handler = new GenealogyGetHandler();
            else if ( method.equals("POST") )
                handler = new GenealogyPostHandler();
            else
